...
It is also in this class that I have implemented both the Minimum distance algorithm and Axis-separation algorithm. I have done so because both algorithms works on rectangles/rectangular boxes, and not only on Rectangular Swept Spheres or any other data-structures. \Sfixme{should there be something here about about what must be done when we are working on a box?}
